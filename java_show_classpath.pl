...
sub show_jinfo_classpath($){
    ...
    foreach(@output){
        ...
        #
        #   /Users/nholuongut/emoji-cheat-sheet/Library/Application Support/JetBrains/IdeaIC2023.3/plugins/sonarlint-intellij/sloop/lib/error_prone_annotations-2.18.0.jar
        #
        #if(/error/i){
