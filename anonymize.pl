#!/usr/bin/perl -T
#
#  Author:       nholuongut/emoji-cheat-sheet
...
$DESCRIPTION = "Anonymizes usernames, passwords, IP addresses, hostnames, emails addresses, Company Name, Your Name(!) from text logs or config files to make suitable for snholuongut/emoji-cheat-sheetng in email with vendors, public tickets, Jiras or pastebin like websites.
...
There is also a newer Python version with more redactions and features such as --hash-hostnames available at https://github.com/nholuongut/DevOps-Python-tools
";
