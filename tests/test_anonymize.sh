...
if [ -z "$test_nums" ]; then
    ...
    run_grep "<email>" $anonymize --email <<< "nholuongut/emoji-cheat-sheet@domain.com"
    # shellcheck disable=SC2086
    run_grep "<email>" $anonymize -E <<< "nholuongut/emoji-cheat-sheet@domain.com"
...
src[18]="nholuongut/emoji-cheat-sheet/blah@realm.com"
dest[18]="<kerberos_principal>"
...
src[23]="openssl req ... -passin nholuongut/emoji-cheat-sheet:mypassword ..."
dest[23]="openssl req ... -passin <password> ..."

src[24]="2018-01-01T00:00:00 INFO user=nholuongut/emoji-cheat-sheet"
dest[24]="2018-01-01T00:00:00 INFO user=<user>"

src[25]="BigInsight:4.2"
dest[25]="BigInsight:4.2"

src[26]="user: nholuongut/emoji-cheat-sheet, password: foo bar"
...
#
#src[38]='MYDOMAIN\nholuongut/emoji-cheat-sheet'
#dest[38]='<domain>\<user>'
#
#src[39]="S-1-5-21-3623811015-3361044348-30300820-1013"
#dest[39]="<windows_SID>"
#
#src[40]="nholuongut/emoji-cheat-sheet/host.domain.com@REALM.COM"
...
#
#src[45]=" --user=nholuongut/emoji-cheat-sheet"
#dest[45]=" --user=<user>"
#
#src[46]=" 1.2.3.4/24"
...
#dest[48]="@<domain>"
#
#src[49]="nholuongut/emoji-cheat-sheet@"
#dest[49]="<user>@"
#
## LDAP too many tests!!
#src[50]="CN=nholuongut/emoji-cheat-sheet,OU=MyOU,DC=MyDomain,DC=com"
...
#dest[52]="DC=<dc>"
#
#src[53]="dn: CN=nholuongut/emoji-cheat-sheet,OU=My OU,DC=MyDomain,DC=com"
##dest[53]="dn: CN=<cn>,OU=<ou>,DC=<dc>,DC=<dc>"
#dest[53]="dn: <dn>"
#
#src[54]="cn: nholuongut/emoji-cheat-sheet"
#dest[54]="cn: <cn>"
#
#src[55]="sn: nho"
#dest[55]="sn: <sn>"
...
#
#src[58]="givenName: nholuongut/emoji-cheat-sheet"
#dest[58]="givenName: <givenname>"
#
#src[59]="distinguishedName: CN=nholuongut/emoji-cheat-sheet,OU=MyOU,DC=MyDomain,DC=com"
...
#
#src[62]="name: nholuongut/emoji-cheat-sheet"
#dest[62]="name: <name>"
#
...
#
#src[66]="sAMAccountName: nholuongut/emoji-cheat-sheet"
#dest[66]="sAMAccountName: <samaccountname>"
#
##src[67]="sAMAccountName: nholuongut/emoji-cheat-sheet"
...
#
#src[70]="uid: nholuongut/emoji-cheat-sheet"
#dest[70]="uid: <uid>"
#
...
#
#src[73]="msSFU30Name: nholuongut/emoji-cheat-sheet"
...
#
#src[75]="unixHomeDirectory: /home/nholuongut/emoji-cheat-sheet"
#dest[75]="unixHomeDirectory: /home/<user>"
#
#src[76]="member: CN=nholuongut/emoji-cheat-sheet,OU=MyOU,DC=MyDomain,DC=com"
...
#
#src[81]="https://mylonggithubtoken@github.com/nholuongut/nagios-plugins"
#dest[81]="https://<user>@<domain>/<custom>/nagios-plugins"
#
## --ldap attribute matches are done before --user matches
#src[82]="uid = nholuongut/emoji-cheat-sheet"
#dest[82]="uid = <uid>"
#
